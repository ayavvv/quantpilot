...
def test_collect_script_runs_futu_collector_with_nas_and_lock():
    ...
    assert 'US_MICROSTRUCTURE_UNIVERSE_TARGET_SIZE="${US_MICROSTRUCTURE_UNIVERSE_TARGET_SIZE:-124}"' in content
    assert 'US_MICROSTRUCTURE_COLLECTION_MAX_SYMBOLS="${US_MICROSTRUCTURE_COLLECTION_MAX_SYMBOLS:-124}"' in content
