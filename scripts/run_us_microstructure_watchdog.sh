...
EXTERNAL_US_MICROSTRUCTURE_ALLOW_SSH_NAS_SYNC="${US_MICROSTRUCTURE_ALLOW_SSH_NAS_SYNC-}"
...
[ -n "$EXTERNAL_US_MICROSTRUCTURE_ALLOW_SSH_NAS_SYNC" ] && US_MICROSTRUCTURE_ALLOW_SSH_NAS_SYNC="$EXTERNAL_US_MICROSTRUCTURE_ALLOW_SSH_NAS_SYNC"
...
US_MICROSTRUCTURE_NAS_HOST="${US_MICROSTRUCTURE_NAS_HOST:-}"
