...
REMOTE_ENV_NAMES=(
    ...
    US_MICROSTRUCTURE_FLOW_RANKING_FILE
    US_MICROSTRUCTURE_UNIVERSE_HISTORY_SLEEP_SECONDS
    US_MICROSTRUCTURE_UNIVERSE_MINUTE_SLEEP_SECONDS
    ...
    US_MICROSTRUCTURE_NAS_MOUNT_DIR
    US_MICROSTRUCTURE_ALLOW_SSH_NAS_SYNC
